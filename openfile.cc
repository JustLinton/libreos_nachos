...
//     FileHeader* nextHeader=NULL;
//     bool hasNext = hdr->getNextSector() != -1;
//     if (hasNext)
//     {
//         nextHeader=new FileHeader();
//         nextHeader->FetchFrom(hdr->getNextSector());
//     }
...
//     if(hasNext){
//         int firstHdrSecCnt = numSectors - hdr->getNumSectors();
//         // int secondHdrSecCnt= numSectors - firstHdrSecCnt;
//         for (i = firstSector; i <= firstSector + firstHdrSecCnt-1; i++)
//             synchDisk->WriteSector(hdr->ByteToSector(i * SectorSize),
//                                    &buf[(i - firstSector) * SectorSize]);

//         for (i = firstSector + firstHdrSecCnt; i <= lastSector; i++)
//             synchDisk->WriteSector(nextHeader ->ByteToSector(i * SectorSize),
//                                    &buf[(i - firstSector) * SectorSize]);
//     }else{
//         for (i = firstSector; i <= lastSector; i++)
//             synchDisk->WriteSector(hdr->ByteToSector(i * SectorSize),
